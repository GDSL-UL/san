...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toptitle=1mm, left=2mm, toprule=.15mm, opacityback=0, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, coltitle=black, arc=.35mm, bottomtitle=1mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, breakable, leftrule=.75mm, rightrule=.15mm, colback=white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0, bottomrule=.15mm]
...
{\centering \includegraphics{04-points_files/figure-pdf/unnamed-chunk-5-1.pdf}
